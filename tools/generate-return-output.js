...
export async function renderGenerateReturnOutput(container, ctx) {
  ...
  container.innerHTML = `
      <div class="card">
          <div class="hRow" style="margin-bottom:10px;">
              ...
              <div style="font-weight:700;">Generate Return Output</div>
              <div></div>
          </div>
          ...
          <div class="row">
              ...
              <select id="outputType">
                  <option value="xml">CCH XML</option>
                  <option value="blackore">BlackOre JSON</option>
              </select>
          </div>
  ...
  function buildUrl() {
      ...
      const url =
          `${cchGatewayApiBase}/api/tax_returns/${returnId}/${output}` +
